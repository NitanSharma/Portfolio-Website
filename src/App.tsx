      ...
      <div className="flex flex-col md:flex-row items-center justify-between px-6 md:px-16 py-16 md:py-20 gap-10 md:gap-16">
        ...
        <div className="flex-1 max-w-2xl text-center md:text-left">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center md:justify-start gap-4 mb-8">
            ...
            <a href="/Nitin_Sharma_CV.pdf" download className="w-full sm:w-auto">
        ...
        <div className="flex-1 flex flex-col items-center gap-8 w-full max-w-md mx-auto">
          ...
          <div className="bg-[#1abc9c] rounded-3xl p-6 sm:p-8 w-full max-w-sm aspect-square flex items-center justify-center border-8 border-black shadow-lg">
            <div className="text-center w-full h-full flex items-center justify-center">
              <img src="/avatar.png" alt="Profile" className="max-w-full max-h-full object-contain" />
            </div>
          </div>

          {/* Social Icons */}
          <div className="flex gap-4 sm:flex-col">
            <a href="https://github.com/NitanSharma" className="rounded-full w-12 h-12 flex items-center justify-center bg-white shadow-lg hover:bg-gray-200 transition">
              <img src="/github.jpg" alt="GitHub" className="w-9 h-9 object-contain" />
            </a>
            <a href="https://www.linkedin.com/in/nitin-sharma-cse/" className="rounded-full w-12 h-12 flex items-center justify-center bg-white shadow-lg hover:bg-gray-200 transition">
              <img src="/linkedin.webp" alt="LinkedIn" className="w-9 h-9 object-contain" />
            </a>
          </div>
        </div>
      </div>
